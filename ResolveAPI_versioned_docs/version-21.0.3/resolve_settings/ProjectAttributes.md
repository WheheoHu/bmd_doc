...
---
This section covers the project attributes returned by [`ProjectManager:GetProjectAttributesInCurrentFolder`](../resolve_api/ProjectManager.md#getprojectattributesincurrentfolder), which maps every project name in the current folder to a dictionary of that project's attributes.
