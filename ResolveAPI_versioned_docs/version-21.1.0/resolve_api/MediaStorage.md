...
Refer to [Clone Tool Settings](../resolve_settings/CloneToolSettings.md) for the returned keys.
...
Refer to [Clone Tool Settings](../resolve_settings/CloneToolSettings.md) for information on supported settings.
