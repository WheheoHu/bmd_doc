...
Refer to [Project and Clip Properties](../resolve_settings/ProjectAndClipProperties.md) for the supported keys.
...
Refer to [Project Settings Preset Info](../resolve_settings/ProjectSettingsPresetInfo.md) for the returned keys.
...
Refer to [Speech Generation Settings](../resolve_settings/SpeechGenerationSettings.md) for information on supported settings.
...
Deprecated since 21.1.0. Refer to [Deprecated API](../other/misc.md#deprecated-resolve-api-functions).
