...
Refer to [Normalize Audio Options](../resolve_settings/NormalizeAudioOptions.md) for information on supported settings.
...
Refer to [Auto Align Options](../resolve_settings/AutoAlignOptions.md) for information on supported settings.
