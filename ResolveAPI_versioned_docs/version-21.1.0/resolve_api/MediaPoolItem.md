...
Refer to [Transcription](../resolve_settings/Transcription.md) for the returned keys.
...
Refer to [Audio Mapping](../resolve_settings/AudioMapping.md) for the mapping format.
...
Applies motion deblur on the MediaPoolItem. Returns the newly created [MediaPoolItem](./MediaPoolItem.md).

Refer to [Motion Deblur Settings](../resolve_settings/MotionDeblurSettings.md) for information on supported settings.
...
Refer to [Analyze Slate Settings](../resolve_settings/AnalyzeSlateSettings.md) for information on markerColor.
...
Deprecated calling convention since 21.1.0. Refer to [Deprecated Calling Conventions](../other/misc.md#deprecated-calling-conventions).
...
Passing `propertyName` is a [deprecated calling convention](../other/misc.md#deprecated-calling-conventions) since 21.1.0 — call the method with no argument and read the key from the returned dict.
...
Passing `metadataType` is a [deprecated calling convention](../other/misc.md#deprecated-calling-conventions) since 21.1.0 — call the method with no argument and read the key from the returned dict.
