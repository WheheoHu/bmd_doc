---
title: Encrypt DCTL Options
displayed_sidebar: apiSidebar
---
This section covers the supported settings for the method [`Resolve:EncryptDCTL`](../resolve_api/Resolve.md#encryptdctlinputpath-encryptdctloptions).
