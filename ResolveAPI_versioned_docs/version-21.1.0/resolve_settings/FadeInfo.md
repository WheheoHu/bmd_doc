...
---
This section covers the dictionary used by [`TimelineItem:GetFades`](../resolve_api/TimelineItem.md#getfades) and [`TimelineItem:SetFades`](../resolve_api/TimelineItem.md#setfadesfades).
