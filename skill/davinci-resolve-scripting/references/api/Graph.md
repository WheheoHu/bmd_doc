...
Sets the cache mode type on the node mapping the node index provided. Refer to [Cache Mode](../settings/CacheModeInformation.md) section below to find the possible values of cache_value.
