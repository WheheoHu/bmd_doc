...
This section covers additional notes for the functions [`Project:GetSettings`](../api/Project.md#getsettings), [`Project:SetSettings`](../api/Project.md#setsettingssettings), [`Timeline:GetSettings`](../api/Timeline.md#getsettings), [`Timeline:SetSettings`](../api/Timeline.md#setsettingssettings), [`MediaPoolItem:GetClipProperty`](../api/MediaPoolItem.md#getclippropertypropertynamenone) and [`MediaPoolItem:SetClipProperty`](../api/MediaPoolItem.md#setclippropertypropertyname-propertyvalue). These functions are used to get and set properties otherwise available to the user through the Project Settings and the Clip Attributes dialogs.

The single-key forms [`Project:GetSetting`](../api/Project.md#getsettingsettingname), [`Project:SetSetting`](../api/Project.md#setsettingsettingname-settingvalue), [`Timeline:GetSetting`](../api/Timeline.md#getsettingsettingname) and [`Timeline:SetSetting`](../api/Timeline.md#setsettingsettingname-settingvalue) accept the same keys, but are a [deprecated calling convention](../deprecated.md#deprecated-calling-conventions) since 21.1.0 — prefer the plural `GetSettings` / `SetSettings` forms.
...
[`Project:GetSettings`](../api/Project.md#getsettings) returns all of the keys below in a single dict, and [`Project:SetSettings`](../api/Project.md#setsettingssettings) accepts any subset of them. Keys marked read only are ignored when setting.
...
[`Timeline:GetSettings`](../api/Timeline.md#getsettings) returns all of the keys below in a single dict, and [`Timeline:SetSettings`](../api/Timeline.md#setsettingssettings) accepts any subset of them.
...
-   for '2x Enhanced' --> [Project:SetSetting('superScale', 2, sharpnessValue, noiseReductionValue)](../api/Project.md#setsettingsettingname-settingvalue), where sharpnessValue is a `float` in the range [0.0, 1.0] and noiseReductionValue is a `float` in the range [0.0, 1.0]
