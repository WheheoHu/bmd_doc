...
This section covers additional notes for the functions [Graph:GetNodeCacheMode(nodeIndex)](../api/Graph.md#getnodecachemodenodeindex) and [Graph:SetNodeCacheMode(nodeIndex, cache_value)](../api/Graph.md#setnodecachemodenodeindex-cache_value).
