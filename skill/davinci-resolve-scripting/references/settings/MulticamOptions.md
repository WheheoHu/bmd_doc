...
This section covers the supported settings for the method [`MediaPool:CreateMulticamClip`](../api/MediaPool.md#createmulticamclipclips-multicamoptions), and the grade option accepted by [`TimelineItem:FlattenMulticam`](../api/TimelineItem.md#flattenmulticamgradeoption).
...
The `gradeOption` argument of [`TimelineItem:FlattenMulticam`](../api/TimelineItem.md#flattenmulticamgradeoption) can be one of the following constants:
