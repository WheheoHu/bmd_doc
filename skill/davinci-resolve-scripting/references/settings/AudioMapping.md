...
This section covers the output for [mpItem.GetAudioMapping()](../api/MediaPoolItem.md#getaudiomapping) and [timelineItem.GetSourceAudioChannelMapping()](../api/TimelineItem.md#getsourceaudiochannelmapping)
...
[mpItem.GetAudioMapping()](../api/MediaPoolItem.md#getaudiomapping) returns a string of the form:
```python
{
