...
This section covers the supported settings for the method [Timeline.CreateSubtitlesFromAudio(autoCaptionSettings)](../api/Timeline.md#createsubtitlesfromaudioautocaptionsettings)
