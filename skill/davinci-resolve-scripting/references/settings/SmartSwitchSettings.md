...
This section covers the supported settings for the method [`TimelineItem:PerformMulticamSmartSwitch`](../api/TimelineItem.md#performmulticamsmartswitchsmartswitchsettings).
